...
line( 'Color',[1 1 1],'EraseMode','background','Xdata', x(i)+[0 0], 'Ydata',[zstart zend]); % remove zero line
line( 'Color',linecolor,'EraseMode','background','LineWidth',linewidth, 'Xdata', tr+x(i), 'Ydata',z);        % negatives line
else % zeros trace
line( 'Color',linecolor,'EraseMode','background','LineWidth',linewidth,'Xdata', [x(i) x(i)], 'Ydata',[zstart zend]);
end;
end;
end